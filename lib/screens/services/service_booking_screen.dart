...
// import '../booking/review_confirm_screen.dart';

// class ServiceBookingScreen extends StatefulWidget {
//   final String serviceId;
//   final String providerId;
//   final String? initialWorkerId; // NEW
...
//     if (ids.isEmpty) return _provider!.workers;
...
//       // prefer passed-in worker if it’s allowed -> else first available
//       final allowedIds = svc.workerIds.toSet();
//       final initial = (widget.initialWorkerId != null &&
//               allowedIds.contains(widget.initialWorkerId))
...
//         date: _selectedDate,
//         serviceDurationMinutes: _service!.duration?.inMinutes ?? 30,
//       );
//     });
//   }
...
//                         final hhmm = hhmmss.substring(0, 5);
...
//                     subtitle:
//                         Text('${(svc.duration ?? Duration.zero).inMinutes}m'),
//                     trailing: Text(
